  ...
  describe 'ユーザー新規登録' do
    ...
    context '新規登録できないとき' do
      ...
      it 'passwordが5文字以下では登録できない' do
        @user.password = '000ax'
        @user.password_confirmation = '000ax'
        @user.valid?
      ...
      it '数字のみのパスワードでは登録できない' do
        ...
        @user.valid?
        expect(@user.errors.full_messages).to include('Password must contain at least one english letter and a number')
      end
      ...
      it 'family_nameは全角でないと登録できない' do
        ...
        @user.valid?
        expect(@user.errors.full_messages).to include('Family name must be full-width character')
      end
      ...
      it 'first_nameは全角でないと登録できない' do
        ...
        @user.valid?
        expect(@user.errors.full_messages).to include('First name must be full-width character')
      end
