class OrderAddress
  ...
  attr_accessor :post_code, :prefecture_id, :city, :building_name, :address, :tel_number, :user_id, :item_id, :token
  ...
  with_options presence: true do
    ...
    validates :city
    validates :address
    validates :tel_number, format: { with: /\A\d{10,11}\z/, message: "must be 10 to 11 digits" }
    validates :item_id
    validates :token
  end
